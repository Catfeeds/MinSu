...
import com.zhuye.minsu.common.adapter.AddressListAdapter;
import com.zhuye.minsu.user.bean.AddressListBean;
import com.zhuye.minsu.user.setting.EditAddressActivity;
        ...
        switch (what){
            case 0x001:
                try {
                    ...
                    if (code == 200) {
                        AddressListBean addressListBean = new Gson().fromJson(result.body(), AddressListBean.class);
                        final AddressListAdapter addressListAdapter = new AddressListAdapter(R.layout.item_address, addressListBean.data);
