...
public class FYiTuiFangOrderListAdapter extends BaseQuickAdapter<OrderBean.Data, BaseViewHolder> {
    private TextView order_pay;
    public FYiTuiFangOrderListAdapter(int layoutResId, @Nullable List<OrderBean.Data> data) {
