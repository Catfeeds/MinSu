...
public class LTuiKuanOrderFragment extends BaseFragment {
    ...
    protected void initData() {
        MinSuApi.tuikuanApply(getActivity(), 0x001, tokenId, callBack);
    }
                ...
                case 0x001:
                    try {
                        ...
                        if (code == 200) {
                            ...
                            final FTuiKuanOrderListAdapter orderListAdapter = new FTuiKuanOrderListAdapter(R.layout.item_landlord_tuikuan_order, orderBean.data);
