...
public class FDaiRuZhuOrderListAdapter extends BaseQuickAdapter<OrderBean.Data, BaseViewHolder> {
    private TextView order_pay;
    public FDaiRuZhuOrderListAdapter(int layoutResId, @Nullable List<OrderBean.Data> data) {
