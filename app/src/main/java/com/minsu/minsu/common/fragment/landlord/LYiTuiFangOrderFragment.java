...
import com.minsu.minsu.common.fragment.landlord.adapter.FYiTuiFangOrderListAdapter;
...
public class LYiTuiFangOrderFragment extends BaseFragment {
    ...
    private int page=1;
    private FYiTuiFangOrderListAdapter orderListAdapter;
private Activity activity;
    ...
    public void setUserVisibleHint(boolean isVisibleToUser)
    {
        ...
        if (isVisibleToUser)
        {
            if (activity!=null)
            {
                MinSuApi.landlordYiTuiFang(getActivity(), 0x001, tokenId, 1,callBack);
            }
        }
    }
    ...
    protected void initListener() {
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener()
        {
            ...
            {
                MinSuApi.landlordYiTuiFangq(getActivity(), 0x001, tokenId, 1,callBack);
        ...
        refreshLayout.setOnLoadmoreListener(new OnLoadmoreListener()
        {
            ...
            {
                MinSuApi.landlordYiTuiFang(getActivity(), 0x002, tokenId, page,callBack);
                if (StorageUtil.getValue(getActivity(),"networks")!=null&&
                        StorageUtil.getValue(getActivity(),"networks").equals("no"))
                {
                ...
                case 0x001:
                    try {
                        ...
                        if (code == 200) {
                            ...
                            orderListAdapter = new FYiTuiFangOrderListAdapter(R.layout.item_landlord_yituifang_order, data);
...
//                            final FTuiKuanOrderListAdapter orderListAdapter = new FTuiKuanOrderListAdapter(R.layout.item_landlord_yituifang_order, data);
//                            recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
//                            recyclerView.setAdapter(orderListAdapter);
                            if (data.size() == 0) {
                                orderListAdapter.setEmptyView(R.layout.empty, recyclerView);
