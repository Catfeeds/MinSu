...
public class YiTuiFangOrderListAdapter extends BaseQuickAdapter<OrderBean.Data, BaseViewHolder> {
    private TextView order_pay;
    public YiTuiFangOrderListAdapter(int layoutResId, @Nullable List<OrderBean.Data> data) {
