...
public class RuZhuZhongOrderListAdapter extends BaseQuickAdapter<OrderBean.Data, BaseViewHolder> {
    public RuZhuZhongOrderListAdapter(int layoutResId, @Nullable List<OrderBean.Data> data) {
    ...
    protected void convert(BaseViewHolder helper, OrderBean.Data item) {
        ...
        if (item.pay_status == 0) {
            ...
            helper.addOnClickListener(R.id.tuifang_tiqian);
        } else if (item.pay_status == -1) {
