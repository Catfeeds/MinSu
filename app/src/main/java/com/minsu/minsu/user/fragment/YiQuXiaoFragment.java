...
public class YiQuXiaoFragment extends BaseFragment
{
    ...
    protected void initListener()
    {
        ...
        refreshLayout.setOnLoadmoreListener(new OnLoadmoreListener()
        {
            ...
            {
                MinSuApi.yiquxiao(getActivity(), 0x003, tokenId, page,callBack);
                if (StorageUtil.getValue(getActivity(),"networks")!=null&&
                        StorageUtil.getValue(getActivity(),"networks").equals("no"))
                {
...
//                            final OrderListAdapter orderListAdapter = new OrderListAdapter(R.layout.item_order, data);
//                            recyclerView = view.findViewById(R.id.recyclerView);
//                            recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
//                            recyclerView.setAdapter(orderListAdapter);
                            if (data.size() == 0)
